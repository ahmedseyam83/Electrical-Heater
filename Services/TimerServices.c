...
static volatile u16 flag=0,c=0,t1,t2,t3;

void TIMER0_SetInterrupt_us(u8 time,void(*local_pf)(void))
{
	OCR0=time-1;
	TIMER0_OC_SetCallBack(local_pf);
}

void TIMER0_SetInterrupt_ms(u16 time,void(*local_pf)(void))
{
	OCR0=time*1000-1;
	TIMER0_OC_SetCallBack(local_pf);
}
